  ...
  return (
    <section id="about" className="relative py-24 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-[-5%] w-[450px] h-[450px] bg-purple-900/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-[-5%] w-[350px] h-[350px] bg-blue-900/5 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.8fr] gap-12 lg:gap-16">
          ...
          <motion.div variants={fadeInUp} className="space-y-6">
            <div className="space-y-3">
              <h2 className="text-xs uppercase tracking-[0.3em] text-purple-500/70 font-semibold">
                About
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                {techStack.map((tech, index) => (
                  <motion.span
                    ...
                    viewport={{ once: true }}
                    className="px-3 py-1.5 rounded-md border border-white/5 bg-white/[0.03] text-[11px] font-mono text-gray-400 hover:text-white hover:border-purple-500/40 hover:bg-purple-500/10 transition-all duration-300"
                  >
                    {tech}
                  </motion.span>
                ))}
